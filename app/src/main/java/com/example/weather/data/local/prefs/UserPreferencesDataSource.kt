package com.example.weather.data.local.prefs
...
private val Context.prefsDataStore: DataStore<Preferences> by preferencesDataStore(name = "user_preferences")
...
class UserPreferencesDataSourceImpl(
    ...
    override val userPreferences: Flow<UserPreferences> = context.prefsDataStore.data.map { prefs ->
        UserPreferences(
